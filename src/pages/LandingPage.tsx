...
import { DropletIcon, Sprout, ArrowRight, Mic, BarChart, Phone } from "lucide-react";
...
const LandingPage: React.FC<LandingPageProps> = ({
  ...
  const content = {
    en: {
      ...
      phoneCta: "Talk to Krishi Mitra",
      phoneLabel: "+1 (434) 772 1158",
      features: [
        {
    ...
    hi: {
      ...
      phoneCta: "कृषि मित्र से बात करें",
      phoneLabel: "+1 (434) 772 1158",
      features: [
        {
          title: "आवाज सहायता",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 relative z-10">
          <div className="container mx-auto px-4 py-6 max-w-6xl relative">
            ...
            <div className="flex flex-col items-center text-center mb-12 relative z-10">
              ...
              <a
                href="tel:+14347721158"
                className="mt-4 inline-flex items-center gap-2 rounded-md border border-earth/40 bg-white/90 px-4 py-2 text-sm font-semibold text-earth shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:bg-earth hover:text-white hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-earth focus:ring-offset-2"
              >
                <span className="flex h-7 w-7 items-center justify-center rounded-full bg-earth/10">
                  <Phone className="h-4 w-4" />
                </span>
                <span className="flex flex-col items-start leading-tight">
                  <span>{activeContent.phoneCta}</span>
                  <span className="text-base tracking-normal">{activeContent.phoneLabel}</span>
                </span>
              </a>
